...
COMPONENT_REGISTRY: dict[str, ComponentDefinition] = {
    "hồ sơ": ComponentDefinition(
        ...
        (
            ...
            r"giấy tờ (?:gì|nào)",
            r"tài liệu (?:gì|nào)",
            r"tài liệu (?:và|,)?\s*thông tin (?:gì|nào)",
            r"đơn (?:gì|nào)",
        ),
        (r"\bhồ sơ\b", r"đơn đề nghị", r"tài liệu", r"thông tin", r"giấy tờ"),
        ("procedure",),
        1.25,
    ),
    "trình tự": ComponentDefinition(
        ...
        (
            ...
            r"\bquy trình\b",
            r"bước\s+\d+",
            r"phải (?:gửi|nộp|thông báo)",
            r"gửi (?:thông báo|hồ sơ)",
        ),
        ("procedure",),
        1.25,
    ),
    ...
    "quyền và nghĩa vụ": ComponentDefinition(
        "quyền và nghĩa vụ",
        (r"quyền\s*(?:,|và)\s*nghĩa vụ (?:gì|nào)", r"những quyền và nghĩa vụ"),
        (r"\bquyền\b.{0,120}\bnghĩa vụ\b", r"\bnghĩa vụ\b.{0,120}\bquyền\b"),
        ("responsibility",),
        1.3,
    ),
    "trách nhiệm": ComponentDefinition(
        ...
        (
            r"\btrách nhiệm\b",
            r"có nghĩa vụ gì",
            r"phải thực hiện những gì",
        ),
        (r"\btrách nhiệm\b", r"\bquyền\b", r"\bnghĩa vụ\b", r"có trách nhiệm", r"phải thực hiện"),
        ("responsibility",),
        1.2,
    ),
}
